...
Сценарий: 01 Оформление графика отпусков
	* Оформление документа
		...
		И в поле с именем 'Номер' я ввожу текст '301'
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
		И я жду закрытия окна 'График отпусков 301 от *' в течение 20 секунд
		Тогда открылось окно 'Графики и переносы отпусков'
	...
	* Проверка заполнения данных
		...
		И Я закрываю окно 'График отпусков 301 от *'
		Тогда открылось окно 'Графики и переносы отпусков'
		И Я закрываю окно 'Графики и переносы отпусков'
...
Сценарий: 02 Оформление отпуска
	* Оформление документа
		...
		Тогда открылось окно 'Графики и переносы отпусков'
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'График отпусков 301 от *'
