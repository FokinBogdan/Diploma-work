...
Сценарий: 01. Заполнение и проведение документа "Отражение зарплаты в бухучете"
	* Заполнение документа
		...
		И в поле с именем 'Номер' я ввожу текст '201'
	...
	* Проверка заполнения данных
		...
		И Я закрываю окно 'Отражение зарплаты в бухучете 201 от *'
		Тогда открылось окно 'Отражение зарплаты в бухучете'
		И Я закрываю окно 'Отражение зарплаты в бухучете'
	* Пометка на удаление
		И В командном интерфейсе я выбираю 'Зарплата' 'Отражение зарплаты в бухучете'
		...
		Тогда открылось окно 'Отражение зарплаты в бухучете'
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Отражение зарплаты в бухучете 201 от *'
